...
public final class FragmentPostBinding implements ViewBinding {
  ...
  private FragmentPostBinding(@NonNull ConstraintLayout rootView, @NonNull TextView authorTv,
      @NonNull ImageView avatarV, @NonNull TextView contentTv, @NonNull MaterialButton likeIb,
      @NonNull MaterialButton menuIb, @NonNull Barrier publishedBarrier,
      @NonNull Barrier publishedBarrier2, @NonNull TextView publishedTv) {
